...
export default function MaterialChat() {
  const { materials, activeMaterialIds } = useAppStore(s=>({ materials: s.materials, activeMaterialIds: s.activeMaterialIds }));
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="p-2 border-b flex flex-wrap gap-1">
        ...
        {chips.length===0 && <span className="text-xs text-gray-500">資料未選択</span>}
      </div>
